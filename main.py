...
scalar_var_index = dataset.variable('Pressure_Coefficient').index + 1
command = '''
    Integrate
    ...
    XVariable=1
'''.format(scalar_var=scalar_var_index)

# print("Executing command:", command)  # Debug print to check command
# tecplot.macro.execute_extended_command('CFDAnalyzer4', command)
